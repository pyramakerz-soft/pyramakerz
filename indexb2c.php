...
<head>
  ...
  <title>Pyramakerz - Student Portal</title>
  ...
  <!-- Vendor CSS Files -->
  <link href="assetsb2c/vendor/aos/aos.css" rel="stylesheet">
  <link href="assetsb2c/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="assetsb2c/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="assetsb2c/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="assetsb2c/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="assetsb2c/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="assetsb2c/css/style.css" rel="stylesheet">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 hero-img image" data-aos="zoom-out" data-aos-delay="200">
          <img src="assetsb2c/img/ai3.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
                ...
                <div class="container-fluid" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-lg-5 align-items-stretch video-box" data-aos="zoom-in-up"
                            style="background-image: url('assetsb2c/img/map.jpg'); background-size: contain; border-radius:60px;"
...
Developer.</p>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box image">
              <img src="assetsb2c/img/course2.png" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
            <div class="box image">
              <img src="assetsb2c/img/course3.png" class="img-fluid" alt="">
        ...
        <div class="row  justify-content-center">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="box image">
              <img src="assetsb2c/img/course4.png" class="img-fluid" alt="">
...
own websites.</p>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box image">
              <img src="assetsb2c/img/course5.png" class="img-fluid" alt="">
              <h3>Robotics Design &
                Programming Path</h3>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 image">
            <img src="assetsb2c/img/level1.png" class="img-fluid" alt="">
          </div>
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div class="service-box orange">
               <div class="image">
                <img src="assetsb2c/img/level1-1.png" style="height: 200px;">
                </div>
                <h2>
            ...
            <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div class="service-box orange">
                <div class="image">
                <img src="assetsb2c/img/level1-2.png" style="height: 200px;">
                </div>
                <h2>
                  PictoBlox – Code.Org
                  (10:18)
      ...
      <section id="features" class="features">
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 image">
              <img src="assetsb2c/img/level2.jpg" class="img-fluid" alt="">
              <br>
          ...
          <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-box orange">
                 <div class="image">
                  <img src="assetsb2c/img/game1.png" style="height: 200px;">
                  </div>
                  <h2>
                  Roblox
                  </h2>
...
Creating custom game mechanics.</p>
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-box orange">
                    <div class="image">
                  <img src="assetsb2c/img/game2.png" style="height: 200px; width:auto;">
                  </div>
                  <h2>
                  Unity
                  </h2>
          ...
          <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-box orange">
                     <div class="image">
                  <img src="assetsb2c/img/mobile1.png" style="height: 200px;">
                   </div>
...
Developing a simple quiz game.</p>
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-box orange">
                    <div class="image">
                  <img src="assetsb2c/img/mobile2.png" style="height: 200px; width:auto;">
                   </div>
                  <h2>
                  Flutter
                  </h2>
...
Training a chatbot.</p>
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-box orange">
                     <div class="image">
                  <img src="assetsb2c/img/ai2.png" style="height: 200px; width:auto;">
                   </div>
                  <h2>
                  Python & ML
                  </h2>
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-box orange">
                  ...
                  <img src="assetsb2c/img/robot1.png" style="height: 200px;">
                  <h2>
...
Building basic robotic systems.</p>
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-box orange">
                     <div class="image">
                  <img src="assetsb2c/img/robot2.png" style="height: 200px; width:auto;">
                  </div>
                  <h2>
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-box orange">
                   ...
                   <div class="image">
                  <img src="assetsb2c/img/web1.png" style="height: 200px; ">
                   </div>
...
Designing custom graphics using Canva.</p>
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-box orange">
                        <div class="image">
                  <img src="assetsb2c/img/web2.png" style="height: 200px; width:auto;">
                   </div>
                  <h2>
...
Adding dynamic features using JavaScript.</p>
  ...
  <script src="assetsb2c/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="assetsb2c/vendor/aos/aos.js"></script>
  <script src="assetsb2c/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="assetsb2c/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="assetsb2c/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="assetsb2c/vendor/swiper/swiper-bundle.min.js"></script>
